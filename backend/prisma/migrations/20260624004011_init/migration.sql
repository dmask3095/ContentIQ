...
CREATE TABLE "content_drafts" (
    ...
    CONSTRAINT "content_drafts_idea_id_fkey" FOREIGN KEY ("idea_id") REFERENCES "content_ideas" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "published_posts" (
    ...
    CONSTRAINT "published_posts_draft_id_fkey" FOREIGN KEY ("draft_id") REFERENCES "content_drafts" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
